        ...
        while not self._stop_event.is_set():
            try:
                if self.cip.restart_connection is False:
                    ...
                    # ⚡ Bolt: Replace time.sleep() with event wait to improve shutdown responsiveness without increasing CPU load.
        ...
        while not self._stop_event.is_set():
            ...
            try:
                ...
                if not self._stop_event.is_set():
                    # ⚡ Bolt: Replace time.sleep() with event wait to drastically reduce shutdown latency
