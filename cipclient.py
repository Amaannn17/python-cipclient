        ...
        while not self._stop_event.is_set():
            try:
                if self.cip.restart_connection is False:
                    ...
                    # ⚡ Bolt: Use self._stop_event.wait(0.1) instead of time.sleep(0.1)
                    # to improve thread shutdown responsiveness by avoiding blocking sleeps
        ...
        while not self._stop_event.is_set():
            ...
            try:
                ...
                if not self._stop_event.is_set():
                    # ⚡ Bolt: Use wait() to avoid blocking thread shutdown
