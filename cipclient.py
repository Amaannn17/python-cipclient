        ...
        while not self._stop_event.is_set():
            try:
                if self.cip.restart_connection is False:
                    ...
                    # Bolt optimization: use _stop_event.wait() instead of time.sleep()
                    # to improve shutdown responsiveness without increasing CPU usage
        ...
        while not self._stop_event.is_set():
            ...
            try:
                ...
                if not self._stop_event.is_set():
                    # Bolt optimization: use _stop_event.wait() instead of time.sleep()
                    # to reduce thread shutdown latency
