...
class EventThread(threading.Thread):
    ...
    def run(self):
        ...
        while not self._stop_event.is_set():
            ...
            # Optimization: prevent eager f-string evaluation in high-frequency event loop
            if _logger.isEnabledFor(logging.DEBUG):
    ...
    def _processPayload(self, ciptype, payload):
        ...
        if ciptype == 0x0D or ciptype == 0x0E:
            ...
            if datatype == 0x00:
                ...
                # Optimization: prevent eager f-string evaluation for digital join payload process
                if _logger.isEnabledFor(logging.DEBUG):
                ...
                # Optimization: prevent eager f-string evaluation for analog join payload process
                if _logger.isEnabledFor(logging.DEBUG):
            ...
            # Optimization: prevent eager f-string evaluation for serial join payload process
            if _logger.isEnabledFor(logging.DEBUG):
