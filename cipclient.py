...
class EventThread(threading.Thread):
    ...
    def run(self):
        ...
        while not self._stop_event.is_set():
            ...
            # Performance optimization: Wrap f-string in isEnabledFor to avoid eager string evaluation overhead
            if _logger.isEnabledFor(logging.DEBUG):
    ...
    def _processPayload(self, ciptype, payload):
        ...
        if ciptype == 0x0D or ciptype == 0x0E:
            ...
            if datatype == 0x00:
                ...
                # Performance optimization: Avoid eager evaluation of f-string logging when debug is off
                if _logger.isEnabledFor(logging.DEBUG):
                ...
                # date/time
                # Performance optimization: Move expensive string extraction and f-string evaluation inside debug check
                if _logger.isEnabledFor(logging.DEBUG):
