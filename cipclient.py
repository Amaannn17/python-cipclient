...
class EventThread(threading.Thread):
    ...
    def run(self):
        ...
        while not self._stop_event.is_set():
            ...
            # Guard against eager f-string evaluation when debug logging is disabled
            if _logger.isEnabledFor(logging.DEBUG):
    ...
    def _processPayload(self, ciptype, payload):
        ...
        if ciptype == 0x0D or ciptype == 0x0E:
            ...
            if datatype == 0x00:
                ...
                # Guard against eager f-string evaluation
                if _logger.isEnabledFor(logging.DEBUG):
                ...
                # date/time
                # Guard against expensive hex conversion and f-string evaluation
                if _logger.isEnabledFor(logging.DEBUG):
