        ...
        while not self._stop_event.is_set():
            try:
                if self.cip.restart_connection is False:
                    ...
                    # ⚡ Bolt: Use self._stop_event.wait instead of time.sleep to improve shutdown responsiveness
        ...
        while not self._stop_event.is_set():
            ...
            try:
                ...
                if not self._stop_event.is_set():
                    # ⚡ Bolt: Use wait instead of sleep to avoid blocking thread shutdown
